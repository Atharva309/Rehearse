 ...
 * Top app bar for Tempo Stage 5 Negotiation — matches Stages 1–4
 * (Rehearse logo, Back, project flow pills, handoff note, restart).
 */
...
const NEGOTIATION_FLOW_INDEX = 4;
